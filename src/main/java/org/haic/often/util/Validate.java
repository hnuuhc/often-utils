...
public class Validate {
	...
	public static <T> T[] noNullElements(final T[] array, final String message, final Object... values) {
		notNull(array);
		for (T t : array) if (t == null) throw new IllegalArgumentException(String.format(message, values));
		return array;
	}
	...
	public static <T extends Iterable<?>> T noNullElements(final T iterable, final String message, final Object... values) {
		notNull(iterable);
		for (Object o : iterable) if (o == null) throw new IllegalArgumentException(String.format(message, values));
		return iterable;
	}
