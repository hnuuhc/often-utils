...
public class LanZouYunPan {
	 ...
	 */
	@Contract(pure = true)
	public static LanZouYunPanAPI localLogin() {
	 ...
	 */
	@Contract(pure = true)
	public static LanZouYunPanAPI localLogin(@NotNull String userHome) {
		return login(LocalCookie.home(userHome).getForDomain("pc.woozooo.com"));
	}

	@Contract(pure = true)
	public static LanZouYunPanAPI login(@NotNull Map<String, String> cookies) {
