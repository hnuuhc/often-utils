...
public class KuaKeYunPan {
	 ...
	 */
	@Contract(pure = true)
	public static KuaKeYunPanAPI localLogin() {
	 ...
	 */
	@Contract(pure = true)
	public static KuaKeYunPanAPI localLogin(@NotNull String userHome) {
	 ...
	 */
	@Contract(pure = true)
	public static KuaKeYunPanAPI login(@NotNull Map<String, String> cookies) {
	...
	public static class KuaKeYunPanAPI {
		...
		private KuaKeYunPanAPI(Map<String, String> cookies) {
