...
public abstract class Evaluator {
	...
	public static final class AttributeStarting extends Evaluator {
		...
		@Override
		public boolean matches(Element root, Element element) {
			List<org.haic.often.net.analyze.nodes.Attribute> values = element.attributes().asList();
			for (org.haic.often.net.analyze.nodes.Attribute attribute : values) {
				if (Normalizer.lowerCase(attribute.getKey()).startsWith(keyPrefix)) return true;
			}
			return false;
		}
	...
	public static final class MatchText extends Evaluator {
		...
		public boolean matches(Element root, Element element) {
			...
			for (TextNode textNode : textNodes) {
				PseudoTextElement pel = new PseudoTextElement(org.haic.often.net.analyze.parser.Tag.valueOf(element.tagName()), element.baseUri(), element.attributes());
