...
import org.haic.often.exception.UncheckedIOException;
...
public final class CharacterReader {
	 ...
	 */
	void unconsume() {
		if (bufPos < 1) throw new UncheckedIOException(new IOException("WTF: No buffer left to unconsume.")); // a bug if this fires, need to trace it.
