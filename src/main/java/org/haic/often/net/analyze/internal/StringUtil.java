package org.haic.often.net.analyze.internal;
...
public final class StringUtil {
	...
	public static String releaseBuilder(StringBuilder sb) {
		...
		if (sb.length() > MaxCachedBuilderSize) sb = new StringBuilder(MaxCachedBuilderSize); // make sure it hasn't grown too big
