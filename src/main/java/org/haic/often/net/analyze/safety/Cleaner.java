...
import org.haic.often.net.analyze.parser.ParseErrorList;
 ...
 * </p>
 * <p>
 * Rather than interacting directly with a Cleaner object, generally see the {@code clean} methods.
 * </p>
 */
	...
	private final class CleaningVisitor implements NodeVisitor {
		...
		public void head(Node source, int depth) {
			if (source instanceof Element sourceEl) {
				...
				if (source instanceof DataNode sourceData && safelist.isSafeTag(source.parent().nodeName())) {
