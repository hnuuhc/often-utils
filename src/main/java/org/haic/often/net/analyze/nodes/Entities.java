...
import static org.haic.often.net.analyze.nodes.Entities.EscapeMode.base;
import static org.haic.often.net.analyze.nodes.Entities.EscapeMode.extended;
			...
			if (codePoint < Character.MIN_SUPPLEMENTARY_CODE_POINT) {
				...
				switch (c) {
					...
					case 0xD:
						...
						break;
					default:
						if (c < 0x20 || !canEncode(Objects.requireNonNull(coreCharset), c, encoder)) appendEncoded(accum, escapeMode, codePoint);
						else accum.append(c);
				}
			} else {
