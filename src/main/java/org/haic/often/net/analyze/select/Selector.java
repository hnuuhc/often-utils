...
import org.haic.often.net.analyze.nodes.PseudoTextElement;
 ...
 * is equivalent).
 * </p>
 * <style>table.syntax tr td {vertical-align: top; padding-right: 2em; padding-top:0.5em; padding-bottom:0.5em; } table.syntax tr:hover{background-color: #eee;} table.syntax {border-spacing: 0px
 * 0px;}</style>
